					...
					<section class='revsec'>
						...
						<table class="tablesize2 ">
							...
							<tbody style="font-family: GangwonEdu_OTFBoldA;">
								<tr>
									<td>지점</td>
									<td><input value="branch" id="branch"></td>
								</tr>
								<tr>
									<td>예약일</td>
									<td><input class="regdate" id="regdate" type="date"
										 style="font-family: GangwonEdu_OTFBoldA;"></td>
								</tr>
								<tr>
									<td>시간</td>
									<td><input type="radio" name="time" value="10:00">
										10:00 <input type="radio" name="time" value="20:00">
										12:00 <input type="radio" name="time" value="14:00">
										14:00 <input type="radio" name="time" value="16:00">
										16:00 <input type="radio" name="time" value="18:00">
										18:00 <input type="radio" name="time" value="20:00">
										20:00</td>
								</tr>
								<tr>
									<td>테마명</td>
									<td><input value="themename" id="themename"></td>
								</tr>
								<tr>
									<td>성함</td>
								...
								<tr>
								<td>예약 인원</td>
								<td><input value="peoplecount" id="peoplecount"><select
								...
								<tr>
									<td>결제 비용</td>
									<td><input value="total" id="total"></td>
								</tr>
