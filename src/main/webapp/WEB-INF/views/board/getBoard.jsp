...
<body class="homepage is-preload">
      ...
      <hr>
      <form action="../board/checkPassBoard.do?seq=${board.seq}" method="post">
         ...
         <table border="1" cellpadding="0" cellspacing="0">
            ...
            <tr>
               ...
               <td align="left"><textarea name="content" cols="40" rows="10" readonly>
      ...
      <!-- 댓글 입력창 -->
      <form action="../replies/new" method='post' id ='replyFrm' name='replyFrm'>
     		<input type='text' size='2 name='bno' id ="bno" readonly value='${board.seq}'>
