...
<body class="is-preload">
	...
	<div class='container'>
		...
		<hr>
		<!-- 1. 폼태그에 속성 추가  -->
		<form action="insertBoard.do" id="insertboard" method='post'
			...
			<table border="1" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td width="70">공지체크</td>
					<td align="left"><input type="checkbox" name='ping' class='ping' style='zoom:1.5;'/></td>
				</tr>
				</c:if>
				<tr>
					<td width="70">제목</td>
				...
				<tr>
					<td>작성자</td>
					<td align="left"><input type="text" size="10" name='userid'
						readonly value="<%=session.getAttribute("loginId")%>" /></td>
				</tr>
				<tr>
					<td>내용</td>
